...
return ( <div>
  ...
  <div className="news">
  <div className="container my-3 mx-3"> <NewsItem title={element.title} imgu={element.urlToImage} newsurl={element.url} imageURL="https://source.unsplash.com/random/200x200?sig=incrementingIdentifier" /></div>
 <div className="container my-3 mx-3">  <NewsItem title={element.title} imgu={element.urlToImage} newsurl={element.url} imageURL="https://source.unsplash.com/random/200x200?sig=2" /></div>
 <div className="container my-3 mx-3">  <NewsItem title={element.title} imgu={element.urlToImage} newsurl={element.url} imageURL="https://source.unsplash.com/random/200x200?sig=3"/></div>
 </div>
</div>)
      })}
   </>
